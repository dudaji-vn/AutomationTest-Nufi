 ...
 * 8. Click Export
 * 9. Verify file downloaded with .md extension
 * 10. Click Cancel to close dialog (cleanup)
 */

WebUI.comment('=== TC03: Export - Markdown (.md) ===')
...
try {
    ...
    // Step 4: Select Type = "markdown (.md)"
    WebUI.comment('Step 4: Selecting Type = "markdown (.md)"...')
    ...
    // Step 9: Verify file downloaded with .md extension
    ...
    WebUI.takeScreenshot('TC03_Export_Markdown_Success.png')
    ...
    WebUI.takeScreenshot('TC03_Export_Markdown_Error.png')
    throw e
}