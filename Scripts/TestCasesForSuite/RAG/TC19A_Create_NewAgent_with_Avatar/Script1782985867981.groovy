...
try {
    ...
    TestObject uploadImg = findTestObject('Object Repository/Core Chat/nav/RAG/Upload an image')
    ...
    WebUI.click(findTestObject('Object Repository/Core Chat/nav/RAG/button_Select a model'))
    WebUI.delay(1.5)

    WebUI.click(findTestObject('Object Repository/Core Chat/nav/RAG/button_Select a provider'))
    WebUI.delay(1)
    WebUI.click(findTestObject('Object Repository/Core Chat/nav/RAG/button_Select a model'))
    WebUI.delay(1.5)
    ...
    WebUI.click(findTestObject('Object Repository/Core Chat/nav/RAG/button_Create'))
    WebUI.delay(5)

    WebUI.verifyElementPresent(findTestObject('Object Repository/Core Chat/nav/RAG/button_Upload for File Search'), 10)
