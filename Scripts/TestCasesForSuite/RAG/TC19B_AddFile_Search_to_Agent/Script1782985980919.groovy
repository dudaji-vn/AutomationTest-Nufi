...
/**
 * TC19B: Add File Search to Existing Agent
 */

WebUI.comment('=== TC19B: Add File Search to Agent ===')
...
try {
    ...
    WebUI.takeScreenshot('TC19B_Add_FileSearch_Success.png')
    WebUI.comment('=== TC19B Completed Successfully ===')

} catch (Exception e) {
    WebUI.comment('TC19B FAILED: ' + e.getMessage())
