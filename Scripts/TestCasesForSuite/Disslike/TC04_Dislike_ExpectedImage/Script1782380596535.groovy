...
/**
 * TC04: Dislike - Expected an image
 * 
 * Test Flow:
 * 1. Click Dislike button of the last message
 * 2. Select "Expected an image" reason
...
WebUI.comment('=== TC04: Dislike (Expected an image) ===')
...
try {
    ...
    WebUI.comment('Step 2: Selecting "Expected an image" reason...')
    ...
    WebUI.takeScreenshot('TC04_Dislike_ExpectedImage_Added.png')
    ...
    WebUI.delay(2)
    WebUI.takeScreenshot('TC04_Dislike_ExpectedImage_Removed.png')
    ...
    WebUI.takeScreenshot('TC04_Dislike_ExpectedImage_Error.png')
    throw e
}