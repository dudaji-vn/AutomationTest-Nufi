...
/**
 * TC06: Dislike - Lacked useful information
 * 
 * Test Flow:
...
WebUI.comment('=== TC06: Dislike (Lacked useful information) ===')
...
try {
    ...
    WebUI.takeScreenshot('TC06_Dislike_LackedUsefulInfo_Added.png')
    ...
    WebUI.delay(2)
    WebUI.takeScreenshot('TC06_Dislike_LackedUsefulInfo_Removed.png')
    ...
    WebUI.takeScreenshot('TC06_Dislike_LackedUsefulInfo_Error.png')
    throw e
}