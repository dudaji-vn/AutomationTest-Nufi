...
/**
 * TC05: Dislike - Refused without reason
 * 
 * Test Flow:
 * 1. Click Dislike button of the last message
 * 2. Select "Refused without reason" reason
...
WebUI.comment('=== TC05: Dislike (Refused without reason) ===')
...
try {
    ...
    WebUI.comment('Step 2: Selecting "Refused without reason" reason...')
    ...
    WebUI.takeScreenshot('TC05_Dislike_RefusedWithoutReason_Added.png')
    ...
    WebUI.delay(2)
    WebUI.takeScreenshot('TC05_Dislike_RefusedWithoutReason_Removed.png')
    ...
    WebUI.takeScreenshot('TC05_Dislike_RefusedWithoutReason_Error.png')
    throw e
}