...
/**
 * TC03: Dislike - Poor style or tone
 * 
 * Test Flow:
 * 1. Click Dislike button of the last message
 * 2. Select "Poor style or tone" reason
...
WebUI.comment('=== TC03: Dislike (Poor style or tone) ===')
...
try {
    ...
    WebUI.comment('Step 2: Selecting "Poor style or tone" reason...')
    ...
    WebUI.takeScreenshot('TC03_Dislike_PoorStyle_Added.png')
    ...
    WebUI.delay(2)
    WebUI.takeScreenshot('TC03_Dislike_PoorStyle_Removed.png')
    ...
    WebUI.takeScreenshot('TC03_Dislike_PoorStyle_Error.png')
    throw e
}