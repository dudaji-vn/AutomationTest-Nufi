...
/**
 * TC03A: Parameters - Frequency Penalty Minimum (-2.0)
 * Verify Frequency Penalty = -2.0 (Minimum)
 */

WebUI.comment('=== TC03A: Frequency Penalty - Minimum (-2.0) ===')
...
try {
    ...
    TestObject sliderThumb = findTestObject('Object Repository/nav/Parameter/slider_Frequency Penalty_thumb')
