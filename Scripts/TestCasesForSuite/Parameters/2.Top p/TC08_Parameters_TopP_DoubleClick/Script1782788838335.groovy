...
/**
 * TC08: Parameters - Top P Double Click Reset
 * Double click the Top P slider thumb to reset to default value (1.0)
 */

WebUI.comment('=== TC08: Top P - Double Click Reset ===')
...
try {
    ...
    WebUI.takeScreenshot('TC08_TopP_DoubleClick_Reset.png')
    WebUI.comment('=== TC08 Completed Successfully ===')

} catch (Exception e) {
    WebUI.comment('TC08 FAILED: ' + e.getMessage())
    WebUI.takeScreenshot('TC08_TopP_DoubleClick_Error.png')
