...
/**
 * TC02A_Parameters_Top_P_Min
 * Verify Top P = 0.0 (Minimum) - slider-only test
 */

WebUI.comment('=== TC02A_Parameters_Top_P_Min: Top P - Minimum (0.0) ===')
...
try {
    ...
    WebUI.takeScreenshot('TC02A_Parameters_Top_P_Min_TopP_Min_Slider.png')
    WebUI.comment('✅ TC02A_Parameters_Top_P_Min PASSED - Top P Minimum slider test')

} catch (Exception e) {
    WebUI.comment('TC02A_Parameters_Top_P_Min FAILED: ' + e.getMessage())
    WebUI.takeScreenshot('TC02A_Parameters_Top_P_Min_Error.png')
