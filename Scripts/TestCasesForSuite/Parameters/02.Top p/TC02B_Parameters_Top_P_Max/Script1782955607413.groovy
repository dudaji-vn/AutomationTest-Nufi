...
/**
 * TC02B_Parameters_Top_P_Max
 * Verify Top P = 1.00 (Maximum) - slider-only test
 */

WebUI.comment('=== TC02B_Parameters_Top_P_Max: Top P - Maximum (1.00) ===')
...
try {
    ...
    WebUI.takeScreenshot('TC02B_Parameters_Top_P_Max_TopP_Max_Slider.png')
    WebUI.comment('✅ TC02B_Parameters_Top_P_Max PASSED - Top P Maximum slider test')

} catch (Exception e) {
    WebUI.comment('TC02B_Parameters_Top_P_Max FAILED: ' + e.getMessage())
    WebUI.takeScreenshot('TC02B_Parameters_Top_P_Max_Error.png')
