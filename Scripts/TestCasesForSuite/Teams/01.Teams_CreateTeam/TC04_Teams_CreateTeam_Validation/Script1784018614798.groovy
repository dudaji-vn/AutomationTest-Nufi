...
/**
 * TC04: Teams - Create Team Validation (missing required fields)
 * 
 * Test Flow:
...
WebUI.comment('=== TC04: Teams - Create Team Validation ===')
...
try {
    ...
    TestObject createButton = findTestObject('Object Repository/nav/Teams/Team/create-team/button_Create_Create Team')
    ...
    WebUI.takeScreenshot('TC04_Teams_CreateTeam_Validation_Success.png')
    WebUI.comment('=== TC04 PASSED ===')

} catch (Exception e) {
    WebUI.comment('=== TC04 FAILED: ' + e.getMessage() + ' ===')
    WebUI.takeScreenshot('TC04_Teams_CreateTeam_Validation_Error.png')
    throw e
}