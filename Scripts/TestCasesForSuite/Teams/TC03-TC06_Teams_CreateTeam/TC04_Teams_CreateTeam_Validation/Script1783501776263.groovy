...
try {
    ...
    if (!hasTeamGrid) {
        ...
        */
        ...
        // FIX: Use XPath with index to avoid type mismatch issue
        // Build XPath with index (1-based)
        ...
        // Click on selected team using the XPath with index
        WebUI.waitForElementClickable(teamCardByIndex, 10)
        WebUI.click(teamCardByIndex)
        WebUI.delay(2)
        
        // Get team name using XPath with index
