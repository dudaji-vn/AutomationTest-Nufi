...
WebUI.comment('=== TC04: Teams - Cancel Delete Team ===')
...
try {
    ...
    WebUI.takeScreenshot('TC04_Teams_CancelDelete_Success.png')
    WebUI.comment('=== TC04 PASSED ===')

} catch (Exception e) {
    WebUI.comment('=== TC04 FAILED: ' + e.getMessage() + ' ===')
    WebUI.takeScreenshot('TC04_Teams_CancelDelete_Error.png')
    throw e
}