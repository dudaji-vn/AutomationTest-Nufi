...
/**
 * TC11: Teams - Invite Member Validation (missing email & invalid email)
 * 
 * Test Flow:
...
WebUI.comment('=== TC11: Teams - Invite Member Validation ===')
...
//    
    ...
    TestObject inviteButton = findTestObject('Object Repository/nav/Teams/Tab_member/Invite-member/button_Invite member')
    ...
    WebUI.setText(
        findTestObject('Object Repository/nav/Teams/Tab_member/Invite-member/input_invite-email'),
        invalidEmail
    )
    ...
    WebUI.click(findTestObject('Object Repository/nav/Teams/Tab_member/Invite-member/button_Cancel_invite'))
    WebUI.delay(1)
    WebUI.comment('✓ Popup closed')
    
    WebUI.takeScreenshot('TC11_Teams_InviteMember_Validation_Success.png')
    WebUI.comment('=== TC11 PASSED ===')

} catch (Exception e) {
    WebUI.comment('=== TC11 FAILED: ' + e.getMessage() + ' ===')
    WebUI.takeScreenshot('TC11_Teams_InviteMember_Validation_Error.png')
    throw e
}