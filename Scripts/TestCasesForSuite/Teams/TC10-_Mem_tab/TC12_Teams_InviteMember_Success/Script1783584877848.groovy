...
/**
 * TC12: Teams - Invite Member Successfully
 * 
 * Test Flow:
...
WebUI.comment('=== TC12: Teams - Invite Member Success ===')

try {
//    String teamName = 'Test Team ' + System.currentTimeMillis()
	String teamName =  WebUI.getText(findTestObject('Object Repository/nav/Teams/team-name'))
...
//        teamName
//    )
//    WebUI.click(findTestObject('Object Repository/nav/Teams/create-team/button_Create_Create Team'))
//    WebUI.delay(3)
//    WebUI.comment('✓ Team created: ' + teamName)
    ...
    WebUI.waitForElementClickable(
        findTestObject('Object Repository/nav/Teams/Tab_member/button_Invite member'),
        10
    )
    WebUI.click(findTestObject('Object Repository/nav/Teams/Tab_member/button_Invite member'))
    WebUI.delay(2)
    WebUI.comment('✓ Invite Member popup opened')
    
    // Step 3: Enter valid email
    WebUI.comment('Step 3: Entering valid email...')
    TestObject emailInput = findTestObject('Object Repository/nav/Teams/Tab_member/Invite-member/input_invite-email')
    ...
    WebUI.click(findTestObject('Object Repository/nav/Teams/Tab_member/Invite-member/button_role'))
    WebUI.delay(1)
    ...
    if (role == 'Admin') {
        ...
        WebUI.click(findTestObject('Object Repository/nav/Teams/Tab_member/Invite-member/Role/sellect_Member'))
    ...
    WebUI.waitForElementClickable(
        findTestObject('Object Repository/nav/Teams/Tab_member/Invite-member/button_Invite member'),
        10
    )
    WebUI.click(findTestObject('Object Repository/nav/Teams/Tab_member/Invite-member/button_Invite member'))
    WebUI.delay(2)
...
//    }
    ...
    WebUI.takeScreenshot('TC12_Teams_InviteMember_Success.png')
    WebUI.comment('=== TC12 PASSED ===')

} catch (Exception e) {
    WebUI.comment('=== TC12 FAILED: ' + e.getMessage() + ' ===')
    WebUI.takeScreenshot('TC12_Teams_InviteMember_Error.png')
    throw e
}