...
/**
 * TC15: Teams - Owner Verifies New Member Added
 * 
 * Test Flow:
...
WebUI.comment('=== TC15: Teams - Owner Verifies New Member Added ===')
...
try {
    ...
    if (!teamFound) {
        ...
        if (!teamFound) {
            ...
            if (!teamFound) {
                WebUI.takeScreenshot('TC15_TeamNotFound.png')
    ...
    if (!hasMember) {
        WebUI.takeScreenshot('TC15_MemberNotFound.png')
    ...
    WebUI.takeScreenshot('TC15_MemberList_Verification.png')
    WebUI.comment('✓ Screenshot taken: TC15_MemberList_Verification.png')
    
    // ============================================================
    // STEP 9: Summary
    // ============================================================
    WebUI.comment('=== TC15 SUMMARY ===')
    WebUI.comment('✓ Team: ' + teamName)
    ...
    WebUI.takeScreenshot('TC15_Error.png')
    throw e
}
