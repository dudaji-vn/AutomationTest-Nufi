...
/**
 * TC18: Teams - Owner Transfer Ownership (Cancel)
 * 
 * Test Flow:
...
WebUI.comment('=== TC18: Teams - Owner Transfer Ownership (Cancel) ===')
...
try {
    ...
    TestObject cancelButton = findTestObject('Object Repository/nav/Teams/Tab_member/Action_to_members/Transfer ownership/button_Cancel')
    ...
    WebUI.takeScreenshot('TC18_TransferOwnership_Cancel_Success.png')
    WebUI.comment('=== TC18 PASSED ===')

} catch (Exception e) {
    WebUI.comment('=== TC18 FAILED: ' + e.getMessage() + ' ===')
    WebUI.takeScreenshot('TC18_TransferOwnership_Cancel_Error.png')
    throw e
}