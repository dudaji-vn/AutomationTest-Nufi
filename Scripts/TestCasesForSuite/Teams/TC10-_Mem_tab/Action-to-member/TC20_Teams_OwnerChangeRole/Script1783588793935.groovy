...
/**
 * TC20: Teams - Owner Change Role (Toggle between Member and Admin)
 * 
 * Test Flow:
...
WebUI.comment('=== TC20: Teams - Owner Change Role ===')
...
try {
    ...
    WebUI.takeScreenshot('TC20_ChangeRole_Success.png')
    ...
    WebUI.takeScreenshot('TC20_ChangeRole_Error.png')
    throw e
}