...
/**
 * TC16: Teams - Owner Removes Member (Cancel)
 * 
 * Test Flow:
...
WebUI.comment('=== TC16: Teams - Owner Removes Member (Cancel) ===')
...
try {
    ...
    TestObject cancelButton = findTestObject('Object Repository/nav/Teams/Tab_member/Action_to_members/Remove/button_Cancel')
    ...
    WebUI.takeScreenshot('TC16_RemoveMember_Cancel_Success.png')
    WebUI.comment('=== TC16 PASSED ===')

} catch (Exception e) {
    WebUI.comment('=== TC16 FAILED: ' + e.getMessage() + ' ===')
    WebUI.takeScreenshot('TC16_RemoveMember_Cancel_Error.png')
    throw e
}