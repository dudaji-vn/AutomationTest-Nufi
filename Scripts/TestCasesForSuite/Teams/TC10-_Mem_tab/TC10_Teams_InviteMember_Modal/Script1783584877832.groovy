...
/**
 * TC10: Teams - Open Invite Member Modal
 * 
 * Test Flow:
...
WebUI.comment('=== TC10: Teams - Open Invite Member Modal ===')
...
//    )
//    WebUI.setText(
//        findTestObject('Object Repository/nav/Teams/create-team/textarea_team-description'),
//        teamDescription
//    )
...
//    WebUI.comment('✓ Team created: ' + teamName)
    ...
    WebUI.takeScreenshot('TC10_Teams_InviteMember_Modal_Success.png')
    WebUI.comment('=== TC10 PASSED ===')

} catch (Exception e) {
    WebUI.comment('=== TC10 FAILED: ' + e.getMessage() + ' ===')
    WebUI.takeScreenshot('TC10_Teams_InviteMember_Modal_Error.png')
    throw e
}