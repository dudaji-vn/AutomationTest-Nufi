...
/**
 * TC13: Teams - Cancel Invite Member
 * 
 * Test Flow:
...
WebUI.comment('=== TC13: Teams - Cancel Invite Member ===')
...
//    
    ...
    WebUI.waitForElementClickable(
        findTestObject('Object Repository/nav/Teams/Tab_member/Invite-member/button_Cancel_invite'),
        10
    )
    ...
    boolean popupClosed = WebUI.waitForElementNotVisible(
        findTestObject('Object Repository/nav/Teams/Tab_member/Invite-member/popup_Invite member'),
        5,
    ...
    WebUI.takeScreenshot('TC13_Teams_InviteMember_Cancel_Success.png')
    WebUI.comment('=== TC13 PASSED ===')

} catch (Exception e) {
    WebUI.comment('=== TC13 FAILED: ' + e.getMessage() + ' ===')
    WebUI.takeScreenshot('TC13_Teams_InviteMember_Cancel_Error.png')
    throw e
}