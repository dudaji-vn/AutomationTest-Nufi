...
try {
    ...
    promptItem.addProperty('xpath', ConditionType.EQUALS, 
        "//section[@aria-label='Prompts']//ul//li[contains(@class, 'rounded-lg')]")
    ...
    firstPromptName.addProperty('xpath', ConditionType.EQUALS, 
        "(//section[@aria-label='Prompts']//ul//li[contains(@class, 'rounded-lg')]//p[contains(@class, 'text-text-primary')])[1]")
    ...
    firstUnsharedButton.addProperty('xpath', ConditionType.EQUALS, 
        "(//section[@aria-label='Prompts']//ul//li[contains(@class, 'rounded-lg')]//button[@aria-label='Unshared from team'])[1]")
