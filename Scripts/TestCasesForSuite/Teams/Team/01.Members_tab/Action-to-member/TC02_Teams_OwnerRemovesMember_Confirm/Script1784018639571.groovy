...
/**
 * TC02: Teams - Owner Removes Member (Confirm)
 * 
 * Test Flow:
...
WebUI.comment('=== TC02: Teams - Owner Removes Member (Confirm) ===')
...
try {
    ...
    TestObject confirmButton = findTestObject('Object Repository/nav/Teams/Team/Tab_member/Action_to_members/Remove/button_Confirm')
    ...
    WebUI.takeScreenshot('TC02_RemoveMember_Confirm_Success.png')
    WebUI.comment('=== TC02 PASSED ===')

} catch (Exception e) {
    WebUI.comment('=== TC02 FAILED: ' + e.getMessage() + ' ===')
    WebUI.takeScreenshot('TC02_RemoveMember_Confirm_Error.png')
    throw e
}