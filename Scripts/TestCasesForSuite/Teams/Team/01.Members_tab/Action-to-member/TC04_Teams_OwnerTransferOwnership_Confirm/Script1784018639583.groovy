...
/**
 * TC04: Teams - Owner Transfer Ownership (Confirm)
 * 
 * Test Flow:
...
WebUI.comment('=== TC04: Teams - Owner Transfer Ownership (Confirm) ===')
...
try {
    ...
    TestObject confirmButton = findTestObject('Object Repository/nav/Teams/Team/Tab_member/Action_to_members/Transfer ownership/button_Confirm')
    ...
    WebUI.takeScreenshot('TC04_TransferOwnership_Confirm_Success.png')
    WebUI.comment('=== TC04 PASSED ===')

} catch (Exception e) {
    WebUI.comment('=== TC04 FAILED: ' + e.getMessage() + ' ===')
    WebUI.takeScreenshot('TC04_TransferOwnership_Confirm_Error.png')
    throw e
}