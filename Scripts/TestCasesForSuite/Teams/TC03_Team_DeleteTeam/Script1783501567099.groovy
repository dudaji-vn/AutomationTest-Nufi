...
WebUI.comment('=== TC03: Teams - Delete Team ===')
...
try {
    ...
    WebUI.takeScreenshot('TC03_Teams_DeleteTeam_Success.png')
    WebUI.comment('=== TC03 PASSED ===')

} catch (Exception e) {
    WebUI.comment('=== TC03 FAILED: ' + e.getMessage() + ' ===')
    WebUI.takeScreenshot('TC03_Teams_DeleteTeam_Error.png')
