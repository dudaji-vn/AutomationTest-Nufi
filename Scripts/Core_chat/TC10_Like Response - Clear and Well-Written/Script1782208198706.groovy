 ...
 * 7. Select "Clear and Well-Written" reason
...
try {
    ...
    WebUI.comment('Step 7: Selecting "Clear and Well-Written" reason...')
    TestObject popup = findTestObject('Object Repository/Core Chat/Love-this/popup_Love-this')
    WebUI.waitForElementVisible(popup, 5)
    
    TestObject reasonOption = findTestObject('Object Repository/Core Chat/Love-this/button_Clear and Well-Written')
