 ...
 * 7. Select "Attention to Detail" reason
...
try {
    ...
    WebUI.comment('Step 7: Selecting "Attention to Detail" reason...')
    ...
    TestObject reasonOption = findTestObject('Object Repository/Core Chat/Love-this/button_Attention to Detail')
