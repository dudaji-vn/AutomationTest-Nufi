...
// Open Fork menu for the latest message
...
// Wait for fork popup and select Visible messages only
...
WebUI.click(findTestObject('Core Chat/Page_T C Gio/Fork/Opt_Visible messages only'))
WebUI.delay(1)

// Optionally check Start fork here and Remember
...
WebUI.takeScreenshot('Fork_VisibleMessagesOnly.png')

WebUI.comment('Fork (Visible messages only) test completed')
