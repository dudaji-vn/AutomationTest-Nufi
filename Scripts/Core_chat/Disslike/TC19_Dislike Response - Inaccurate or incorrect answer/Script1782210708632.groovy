 ...
 * 7. Select "Inaccurate or incorrect answer" reason
...
try {
    ...
    WebUI.comment('Step 7: Selecting "Inaccurate or incorrect answer" reason...')
    ...
    TestObject reasonOption = findTestObject('Object Repository/Core Chat/Action/Needs improvement/button_Inaccurate or incorrect answer')
