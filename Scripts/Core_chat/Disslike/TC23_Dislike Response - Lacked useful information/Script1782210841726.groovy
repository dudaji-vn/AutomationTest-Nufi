...
/**
 * TC23: Dislike Response - Lacked useful information
 * 
 * Test Flow:
 * 1. Open browser
 * 2. Login
 ...
 * 7. Select "Lacked useful information" reason
 * 8. Verify dislike success
 */

WebUI.comment('=== TC23: Dislike Response (Lacked useful information) ===')
...
try {
    ...
    WebUI.comment('Step 7: Selecting "Lacked useful information" reason...')
    ...
    TestObject reasonOption = findTestObject('Object Repository/Core Chat/Action/Needs improvement/button_Lacked useful information')
    ...
    WebUI.takeScreenshot('TC23_Dislike_LackedUsefulInfo_Success.png')
    ...
    WebUI.takeScreenshot('TC23_Dislike_LackedUsefulInfo_Error.png')
    CustomKeywords.'keywords.ChatKeywords.closeBrowser'()
    throw e
}