 ...
 * 5. Select "Lacked useful information" reason
...
try {
    ...
    // Step 5: Select "Lacked useful information" reason
    WebUI.comment('Step 5: Selecting "Lacked useful information" reason...')
