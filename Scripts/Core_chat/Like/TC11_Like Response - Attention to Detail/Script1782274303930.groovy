...
/**
 * TC11: Like Response - Attention to Detail
 * 
 * Test Flow:
 * 1. Open browser
 * 2. Login
 ...
 * 5. Select "Attention to Detail" reason
 * 6. Verify like success
 */

WebUI.comment('=== TC11: Like Response (Attention to Detail) ===')
...
try {
    ...
    // Step 5: Select "Attention to Detail" reason
    WebUI.comment('Step 5: Selecting "Attention to Detail" reason...')
    ...
    TestObject reasonOption = new TestObject('dynamic_attention_reason')
    reasonOption.addProperty('xpath', ConditionType.EQUALS, 
        "//*[@type='button' and (text()='Attention to Detail' or .='Attention to Detail')]")
    ...
    WebUI.takeScreenshot('TC11_Like_AttentionToDetail_Success.png')
    ...
    WebUI.takeScreenshot('TC11_Like_AttentionToDetail_Error.png')
    CustomKeywords.'keywords.ChatKeywords.closeBrowser'()
    throw e
}