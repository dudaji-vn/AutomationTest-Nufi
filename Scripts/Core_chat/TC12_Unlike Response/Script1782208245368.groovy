 ...
 * 9. Click Like button again to remove like
 * 10. Verify like removed
 */
...
try {
    ...
    String testMessage = 'Unlike test message'
    ...
    WebUI.comment('Step 9: Clicking Like button again to remove like...')
    WebUI.waitForElementVisible(likeButton, 5)
    WebUI.click(likeButton)
    WebUI.comment('Like button clicked again to remove like')

    WebUI.comment('Step 10: Verifying like removed...')
    WebUI.delay(2)
