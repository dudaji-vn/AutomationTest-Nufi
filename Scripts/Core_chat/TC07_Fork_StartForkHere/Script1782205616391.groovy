...
try {
    ...
    // Uncheck "Remember" checkbox if checked
    WebUI.comment('Ensuring "Remember" checkbox is unchecked...')
    ...
    // Get current state and uncheck if checked
    ...
    // Wait for success message to disappear before next test
    ...
    // Click Fork menu again
    WebUI.waitForElementVisible(forkMenuButton, 5)
    WebUI.click(forkMenuButton)
    WebUI.comment('Fork menu button clicked again')
    
    // Check "Start fork here" again
    WebUI.waitForElementVisible(startForkCheckbox, 5)
    WebUI.click(startForkCheckbox)
    WebUI.comment('"Start fork here" checkbox checked')
    
    // Uncheck "Remember" again
    WebUI.waitForElementVisible(rememberCheckbox, 5)
    ...
    // Click "Include related branches" option
    ...
    // Click "Include all to/from here" option
