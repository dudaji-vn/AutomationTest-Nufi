...
/**
 * MODEL_ENDPOINT_002_Select_Nufi_Qwen
 * 
 * Test Flow:
 ...
 * 5. Select Nufi Qwen2.5-0.5B endpoint and verify
 */

WebUI.comment('=== MODEL_ENDPOINT_002_Select_Nufi_Qwen ===')
...
try {
    ...
    // ================================================================
    // Step 5: Select Nufi Qwen endpoint and verify
    // ================================================================
    WebUI.comment('Step 5: Selecting Nufi Qwen2.5-0.5B endpoint...')
    ...
    if (agentName.contains('Qwen2.5-0.5B')) {
        ...
        WebUI.takeScreenshot('MODEL_ENDPOINT_002_Select_Nufi_Qwen_Success.png')
    } else {
        WebUI.comment('ERROR: Expected "Qwen2.5-0.5B" but got: ' + agentName)
        WebUI.takeScreenshot('MODEL_ENDPOINT_002_Select_Nufi_Qwen_Failed.png')
        throw new Exception('Nufi/Qwen endpoint selection failed. Expected "Qwen2.5-0.5B" but got: ' + agentName)
    }
    
    WebUI.delay(2)
    WebUI.comment('=== MODEL_ENDPOINT_002_Select_Nufi_Qwen PASSED ===')

} catch (Exception e) {
    WebUI.comment('=== MODEL_ENDPOINT_002_Select_Nufi_Qwen FAILED: ' + e.getMessage() + ' ===')
    WebUI.takeScreenshot('MODEL_ENDPOINT_002_Select_Nufi_Qwen_Error.png')
    throw e
} finally {
    WebUI.closeBrowser()
}