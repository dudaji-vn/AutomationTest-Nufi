 ...
 * 5. Select "Poor style or tone" reason
...
try {
    ...
    // Step 5: Select "Poor style or tone" reason
    WebUI.comment('Step 5: Selecting "Poor style or tone" reason...')
    ...
    reasonOption.addProperty('xpath', ConditionType.EQUALS, 
        "//*[@type='button' and (text()='Poor style or tone' or .='Poor style or tone')]")
